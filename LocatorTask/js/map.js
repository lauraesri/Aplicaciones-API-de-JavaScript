...
// @formatter:on
        ...
        ready(function () {
             ...
             */
            var taskLocator = new Locator("https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer");


            /*
             * Step: Wire the button's onclick event handler
             */
            on(dom.byId("btnLocate"), "click", addressToLocations);
